...
db.session.add(p)
p  = models.Page(url='http://www.thetravelmagazine.net', timestamp=datetime.datetime.utcnow(), category=u)
db.session.add(p)
p  = models.Page(url='https://www.buzzfeed.com/travel', timestamp=datetime.datetime.utcnow(), category=u)
db.session.add(p)
